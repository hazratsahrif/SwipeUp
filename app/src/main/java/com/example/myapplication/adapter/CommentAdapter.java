...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ViewModel>{
    ...
    com.example.myapplication.adapter.onLongPress onLongPress;
    Context context;
    ...
    public CommentAdapter(List<BottomCommentDataModel> itemList, Context context, com.example.myapplication.adapter.onLongPress onLongPress) {
